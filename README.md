...
> **Deployment-only repository** — Source of truth: [omni-medical-suite/apps/trainer-ui/](https://github.com/DrAbdulmalek/omni-medical-suite/tree/main/apps/trainer-ui)
...
| Production OCR | [omni-medical-suite/apps/handwriting-demo/](https://github.com/DrAbdulmalek/omni-medical-suite/tree/main/apps/handwriting-demo) |

## Related Repositories

| Repo | Role | Status |
|------|------|--------|
| [omni-medical-suite/apps/trainer-ui/](https://github.com/DrAbdulmalek/omni-medical-suite/tree/main/apps/trainer-ui) | Source of Truth | Active |
| [omni-medical-suite/apps/handwriting-demo/](https://github.com/DrAbdulmalek/omni-medical-suite/tree/main/apps/handwriting-demo) | Handwriting + Clinical | Active |
